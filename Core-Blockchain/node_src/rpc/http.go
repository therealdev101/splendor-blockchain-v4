...
var DefaultHTTPTimeouts = HTTPTimeouts{
	ReadTimeout:  120 * time.Second,  // increased for high TPS
	WriteTimeout: 120 * time.Second,  // increased for high TPS
	IdleTimeout:  300 * time.Second,  // increased for high TPS
}
