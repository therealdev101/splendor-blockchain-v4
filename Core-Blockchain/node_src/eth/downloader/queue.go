...
var (
	blockCacheMaxItems     = 2048              // Reduced from 8192 - fewer blocks cached for large blocks (150k+ tx)
	blockCacheInitialItems = 512               // Reduced from 2048 - fewer initial blocks for large blocks
	blockCacheMemory       = 1024 * 1024 * 1024 // Increased from 256MB to 1GB - more memory for large blocks
	blockCacheSizeWeight   = 0.3               // Increased from 0.1 - better size estimation for large blocks
)
